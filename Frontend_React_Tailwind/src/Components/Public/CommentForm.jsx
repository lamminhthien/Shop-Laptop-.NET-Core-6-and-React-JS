...
export default function CommentForm(props) {
  ...
  } else if (isAdmin) return <div className='px-14 block'>
    <h2 className='text-black text-xl font-medium'>Đừng quên phản hồi bình luận của khách hàng</h2>
  </div> 
  if (!isLogin)  return <div className='px-16 block'>
    <h2 className='text-black text-xl font-medium'>Hãy đăng nhập để bình luận, đặt câu hỏi về sản phẩm này</h2>
  </div>
}
