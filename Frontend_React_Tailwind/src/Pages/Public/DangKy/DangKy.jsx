...
export default function DangKy() {
  ...
  const formStyle = `mt-2 rounded-xl bg-white border
 border-gray-200  p-2 sm:p-6 col-span-8  drop-shadow-2xl overscroll-contain`;

  return (
    <div>
      <Navbar />
      <div className='inner lg:grid grid-cols-12 bg-blend-darken bg-[url("https://images.unsplash.com/photo-1656608198683-0c586e170e43?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=627&q=80")]'>
        <div className=" col-span-4 lg:pt-14 px-4">
          <div className='title text-4xl text-center  text-white'>Đăng ký tài khoản để sử dụng giỏ hàng, bình luận sản phẩm và mua hàng</div>
        </div>
